(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactNotifier"] = factory(require("react"));
	else
		root["ReactNotifier"] = factory(root["React"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoteSource = __webpack_require__(1);
	var NotificationActions = __webpack_require__(2);
	// Exports components
	module.exports = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoteSource = React.createClass({
	  ...
	  _buildProps: function _buildProps() {
	    ...
	    var archived = _state.archived;

	    delete props.className;

	    return _.extend(props, { notifications: notifications, archived: archived, actions: actions });
	  },
	  /**
...
/***/ function(module, exports, __webpack_require__) {
	...
	function NotificationActions() {
	  return Reflux.createActions(['clearNotifications', 'create', 'destroy', 'error', 'info', 'success']);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NotificationStore = Reflux.createStore({
	  ...
	  create: function create(notification) {
	    var _this = this;
	    ...
	    setTimeout((function () {
	      _this.destroy(notification);
	    }).bind(this), notification.timeout);
	  },
	  destroy: function destroy(oldNote) {
	  ...
	  clearNotifications: function clearNotifications() {
	    var tag = arguments[0] === undefined ? 'general' : arguments[0];
	  ...
	  archive: function archive(notification) {
	    this._archived.push(notification);
	  },
	  getNotes: function getNotes() {
	    var tag = arguments[0] === undefined ? 'general' : arguments[0];

	    return _.where(this._notifications, { tag: tag });
	  },
	  getArchived: function getArchived() {
	    var tag = arguments[0] === undefined ? 'general' : arguments[0];

	    return _.where(this._archived, { tag: tag });
	  } });
